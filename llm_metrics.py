...
3. For questions about areas, the answer is considered correct if any of the following requirements are met: (1) the absolute error is less than 1 square meters (2) the relative error is less than 10%.
