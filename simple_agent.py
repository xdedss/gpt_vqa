...
from agents.environment.tools import ImageMetaTool
...
'''
        ...
        prompt = f'''
You are an AI assistant that make plan to use tools available to solve the user's request. First you should analyze the user's request and break them into sequential steps. In each step you can use one tool, please clarify which tool you want to use, what is used as its input, and how do you save its output. Finally, you will summarize your plan with an array of actions following strict json format like {json_example}.
...
if __name__ == '__main__':
    ...
    a.chat('Can you see sky in the image?')
